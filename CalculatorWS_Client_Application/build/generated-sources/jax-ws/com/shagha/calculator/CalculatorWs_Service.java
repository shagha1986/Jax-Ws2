 ...
 * 
 */
@WebServiceClient(name = "CalculatorWs", targetNamespace = "http://calculator.shagha.com/", wsdlLocation = "http://localhost:8080/CalculatorWs/CalculatorWs?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORWS_QNAME = new QName("http://calculator.shagha.com/", "CalculatorWs");
    ...
    public CalculatorWs getCalculatorWsPort() {
        return super.getPort(new QName("http://calculator.shagha.com/", "CalculatorWsPort"), CalculatorWs.class);
    }
    ...
    public CalculatorWs getCalculatorWsPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://calculator.shagha.com/", "CalculatorWsPort"), CalculatorWs.class, features);
    }
